...
function MedicineDetail({ medicine, setCurrentPage }) {
      ...
      <div className="detail-container">
        ...
        <div className="detail-right">
          ...
          <div className="detail-info-grid">
            ...
            <div className="detail-info-card highlight-green">
              <h3>📅 Manufacture Date</h3>
              <p>{medicine.manufactureDate}</p>
            </div>

            <div className="detail-info-card highlight-red">
              <h3>⏳ Expiry Date</h3>
            ...
            <div className="detail-info-card">
              <h3>🔢 Batch Number</h3>
              <p>{medicine.batchNo}</p>
            </div>

            <div className="detail-info-card">
              <h3>💊 Pack Size</h3>
              <p>{medicine.packSize}</p>
            </div>
          ...
          <div className="detail-section highlight-yellow">
            <h3>🚨 Warnings</h3>
            <p>{medicine.warnings}</p>
          </div>

          <div className="detail-section">
            <h3>🌡️ Storage Instructions</h3>
